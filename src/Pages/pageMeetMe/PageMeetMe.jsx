      ...
      <header className="flex flex-col items-center justify-center gap-6">
        <div className="relative inline-flex transition-all hover:scale-105">
          ...
          <figure>
            ...
            />
            <figcaption className="sr-only">Foto de Pedro Paulo</figcaption>
          </figure>
        </div>
        <section
        ...
        <nav aria-label="Navegação de tema e links sociais">
        ...
        >
          <p>Conteudo criado para ampliar meus conhecimentos :D</p>
        </footer>
      </header>
    </main>
  );
